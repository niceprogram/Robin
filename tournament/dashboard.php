...
<div class="tv-header d-flex justify-content-between align-items-center">
    <div class="tv-title">🏆 Community Center Tournament</div>
    <div class="text-end">
...
<div class="container-fluid px-4 pb-4">
    <div class="row">
        <div class="col-lg-8">
            <div class="section-title">Matches this round <span class="tap-hint">— tap a match to enter its result</span></div>
        ...
        <div class="col-lg-4">
            ...
            <div class="leaderboard-panel">
                <table class="table table-borderless mb-0">
                    <thead>
                        <tr><th>#</th><th>Name</th><th>Points</th><th>Wins</th></tr>
                    </thead>
...
<!-- Fullscreen result-entry overlay: opened by tapping a "Playing…" match card -->
